...
#os.environ["AIRFLOW_HOME"] = "plugins"
...
def format_to_parquet(src_file):
    print("---------------------ENV-------------------------")
    print(os.environ.get('GOOGLE_APPLICATION_CREDENTIALS', 'no cred(((((((((((((((((('))
    print(os.environ.get('AIRFLOW_HOME', 'no home(((((((((((((((((('))
    ...
    cred = Variable.get("cred")
    print(cred)

    open("cr.json", "w").write(cred)
    #open("content/cred.json", "w").write(cred)
